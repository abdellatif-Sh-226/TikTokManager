...
<section>
    ...
    <ul>
        ...
        <li>You agree not to use the Application for any unlawful or prohibited purpose.</li>
        <li>You must comply with TikTok's Community Guidelines and Terms of Service at all times.</li>
    </ul>
</section>
...
<section>
    ...
    <p>
        We collect and process data in accordance with our Privacy Policy. By using the Application,
        you consent to the collection and use of your information as described therein.
    </p>
</section>
...
<section>
    ...
    <p>
        ...
        with an updated revision date. Continued use of the Application after changes constitutes acceptance of the new terms.
    </p>
</section>
