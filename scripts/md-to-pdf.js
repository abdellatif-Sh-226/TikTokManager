...
const mdPath = resolve(rootDir, 'DOCUMENTATION_AR.md')
const htmlPath = resolve(rootDir, 'temp-doc.html')
const pdfPath = resolve(rootDir, 'DOCUMENTATION_AR.pdf')
...
<body>
  <div class="header">
    <h1>📘 TikTok Manager - التوثيق الكامل</h1>
    <p>دليل شامل لفهم كل جزء من المشروع</p>
  </div>
  ${marked(md)}
</body>
</html>`
